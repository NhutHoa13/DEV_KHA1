...
class CanhanProvider{
 ...
 static Future<List<CanhanObject>> getAllContact() async{
    List<CanhanObject> lsResult = [];
    List<dynamic> data = await readJsonData();

    lsResult = data.map((e) => CanhanObject.fromJson(e)).toList();
    return lsResult;

  }
  static Future<List<CanhanObject>> getAllContacts()async{
    List<CanhanObject> lsResult = [];
    List<dynamic> data = await readJsonData();
    lsResult = data.map((e) => CanhanObject.fromJson(e)).toList();
    return lsResult;
