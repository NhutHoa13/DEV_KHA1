...
class man5 extends StatefulWidget {
  int socau;
  man5({super.key, required this.socau});

  @override
  State<man5> createState() => _man5State();
}

class _man5State extends State<man5> {
  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: DefaultAssetBundle.of(context).loadString("data/man5.json"),
